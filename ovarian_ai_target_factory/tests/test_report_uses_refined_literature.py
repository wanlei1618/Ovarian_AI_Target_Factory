...
def test_report_uses_refined_literature(tmp_path):
    suffix = "20260724"
    ...
    assert "unrefined high" not in report
    assert "refined low" not in report.split("## 2. Background/method papers")[0]
